...
import (
	...
	repository "github.com/sema0205/avito-backend-assignment-2024/internal/repository"
)
...
func (m *MockBanner) GetByTagIdAndFeatureId(ctx context.Context, input repository.GetUserBannerInput) (domain.Banner, error) {
	m.ctrl.T.Helper()
...
func (m *MockBanner) GetFilteredBanners(ctx context.Context, input repository.GetFilteredBannerInput) ([]domain.Banner, error) {
	m.ctrl.T.Helper()
...
func (m *MockBanner) Update(ctx context.Context, input repository.UpdateBannerInput) error {
	m.ctrl.T.Helper()
...
func (m *MockAdmin) GetByCredentials(ctx context.Context, input repository.CredentialsInput) (domain.Admin, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByCredentials", ctx, input)
...
func (mr *MockAdminMockRecorder) GetByCredentials(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByCredentials", reflect.TypeOf((*MockAdmin)(nil).GetByCredentials), ctx, input)
}
...
// GetByCredentials mocks base method.
func (m *MockUser) GetByCredentials(ctx context.Context, input repository.CredentialsInput) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByCredentials", ctx, input)
...
// GetByCredentials indicates an expected call of GetByCredentials.
func (mr *MockUserMockRecorder) GetByCredentials(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByCredentials", reflect.TypeOf((*MockUser)(nil).GetByCredentials), ctx, input)
}
